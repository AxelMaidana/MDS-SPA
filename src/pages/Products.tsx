...
const Products = () => {
  ...
  const getFilteredCategories = () => {
    // Siempre devolver todas las categorías del tipo seleccionado
    // Esto asegura que el menú de categorías siempre esté disponible
      ...
      <div className="min-h-screen bg-gray-50 pt-20">
        <div className="container mx-auto px-4 py-8">
            ...
            <div className={`mt-4 ${showFilters ? "block" : "hidden lg:block"}`}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {/* Siempre mostrar el botón de limpiar filtros cuando hay un filtro activo */}
                  {(selectedCategory || selectedType || searchTerm) && (
                    <div className="mt-2">
                      <button
                        onClick={clearFilters}
                        className="px-3 py-1 bg-red-500/50 text-white rounded-md hover:bg-red-500/80 transition-colors text-sm"
                      >
                        Limpiar filtros
                      </button>
                    </div>
          ...
          <div className="flex justify-center items-center h-64">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#0C9383]"></div>
          </div>
        </div>
      </div>
    );
        ...
        {filteredProducts.length === 0 ? (
          <div className="text-center py-12">
            ...
            {(selectedCategory || selectedType || searchTerm) && (
              <button
                onClick={clearFilters}
                className="px-6 py-3 bg-[#0C9383] text-white rounded-lg hover:bg-[#0a7a6b] transition-colors font-medium"
              >
