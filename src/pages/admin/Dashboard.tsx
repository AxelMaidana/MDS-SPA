  ...
  useEffect(() => {
    const obtenerDatosDashboard = async () => {
      try {
        ...
        const datosTendencia = await Promise.all(
          meses.map(async (mes) => {
            const q = query(
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      ...
                      <tr className="bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">
                          $
                          {totalesPorServicioEjemplo
                            .reduce((sum, s) => sum + s.total, 0)
                            .toLocaleString("es-AR")}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">
                          {totalesPorServicioEjemplo.reduce(
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      ...
                      <tr className="bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">
                          $
                          {totalesPorProfesionalEjemplo
                            .reduce((sum, p) => sum + p.total, 0)
                            .toLocaleString("es-AR")}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">
                          {totalesPorProfesionalEjemplo.reduce(
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-8">
              <div className="p-6 border-b border-gray-200">
                <div className="flex justify-between items-center">
                  ...
                  <Link
                    to="/appointments"
                    className="text-[#0C9383] hover:text-[#0C9383]/80 text-sm font-medium flex items-center"
                  >
                    Ver todas
                    ...
                    {citasRecientes.map((cita) => (
                      <tr key={cita.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${obtenerClaseEstado(
                              cita.estado
                            )}`}
                          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <p className="text-gray-600 text-sm flex-grow">
                  Agrega, edita o elimina servicios del spa.
                </p>
              ...
              <Link
                ...
                className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex flex-col"
              >
                <Package size={24} className="text-[#0C9383] mb-4" />
                <h3 className="text-lg font-medium text-gray-800 mb-2">
                  Administrar Productos
                </h3>
                <p className="text-gray-600 text-sm flex-grow">
                  Gestiona el catálogo de productos del spa.
                </p>
                <div className="text-[#0C9383] mt-4 text-sm font-medium flex items-center">
                  Ir a Productos
                  <ArrowRight size={16} className="ml-1" />
              ...
              >
                ...
                <p className="text-gray-600 text-sm flex-grow">
                  Revisa y gestiona candidatos para tu equipo.
                </p>
                <div className="text-[#0C9383] mt-4 text-sm font-medium flex items-center">
                  Ver Solicitudes
                  <ArrowRight size={16} className="ml-1" />
              ...
              >
                ...
                <p className="text-gray-600 text-sm flex-grow">
                  Visualiza y gestiona las cuentas de usuarios.
                </p>
                <div className="text-[#0C9383] mt-4 text-sm font-medium flex items-center">
                  Ir a Usuarios
                  <ArrowRight size={16} className="ml-1" />
