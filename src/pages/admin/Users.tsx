...
const AdminUsers = () => {
  ...
  const specialties = {
    ...
    groupServices: ["Hidromasajes", "Yoga"],
  };
  ...
  const applyFilters = () => {
    ...
    if (specialtyFilter !== "all") {
      result = result.filter(
        (user) => user.role === "staff" && user.specialty === specialtyFilter
      );
    }
    ...
    if (
      ...
      try {
        ...
        if (userDoc.exists()) {
          ...
          if (
            userData.imageUrl &&
            userData.imageUrl.includes("firebasestorage")
          ) {
        ...
        {showFilters && (
          <div className="bg-white p-4 rounded-lg shadow-sm mb-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="form-group">
                <label htmlFor="specialtyFilter" className="form-label">
                  Filter by Specialty
                </label>
                <select
                  id="specialtyFilter"
                  ...
                  <div className="absolute top-0 right-0 p-2 flex space-x-2">
                    ...
                    >
                      {deleteId === user.id ? (
                        <Loader2
                          size={16}
                          className="text-error-600 animate-spin"
                        />
                      ) : (
                  ...
                  >
                    ...
                    <optgroup label="Massages">
                      {specialties.massages.map((item, index) => (
                        <option key={`massage-${index}`} value={item}>
                          {item}
                        </option>
                      ))}
                    </optgroup>
                    ...
                    <optgroup label="Beauty Treatments">
                      {specialties.beauty.map((item, index) => (
                        <option key={`beauty-${index}`} value={item}>
                          {item}
                        </option>
                      ))}
                    </optgroup>
                    ...
                    <optgroup label="Facial Treatments">
                      {specialties.facialTreatments.map((item, index) => (
                        <option key={`facial-${index}`} value={item}>
                          {item}
                        </option>
                      ))}
                    </optgroup>
                    ...
                    <optgroup label="Body Treatments">
                      {specialties.bodyTreatments.map((item, index) => (
                        <option key={`body-${index}`} value={item}>
                          {item}
                        </option>
                      ))}
                    </optgroup>
...
const placeholderUsers = [
  {
    ...
    role: "client",
    imageUrl:
      "https://images.pexels.com/photos/5599437/pexels-photo-5599437.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  },
  {
    id: "user2",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.pexels.com/photos/3865676/pexels-photo-3865676.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  },
];
